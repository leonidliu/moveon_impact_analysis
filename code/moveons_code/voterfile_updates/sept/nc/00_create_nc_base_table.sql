...
drop table if exists election_2024.exp2024_basefile_nc_20240920;
create table election_2024.exp2024_basefile_nc_20240920 as (
    select *
    from base
    where
...
(
    ...
    from election_2024.exp2024_basefile_nc_20240920
    where
        is_callable = 1  -- has high quality phone number in the voter file
        and do_not_call = 0 -- not on the do not call list
);

drop table if exists election_2024.exp2024_deduped_nc_20240920;
create table election_2024.exp2024_deduped_nc_20240920 as (
    select base.*
    from election_2024.exp2024_basefile_nc_20240920 as base
