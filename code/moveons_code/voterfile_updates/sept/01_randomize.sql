...
create temp table base as (
    ...
    from election_2024.exp2024_deduped_20240917 as base

   --- election_2024.exp2024_deduped_20240816 as base
   left join election_2024.exp2024_ucg_august as aug
        on base.vb_voterbase_id = aug.vb_voterbase_id
    left join election_2024.exp2024_ucg_july as july
        on base.vb_voterbase_id = july.vb_voterbase_id
    left join
    ...
    left join  hh_aug
        on base.vb_tsmart_last_name
            || base.vb_vf_reg_cass_address_full
            || base.vb_vf_reg_cass_city
            || base.vb_vf_reg_cass_state
            || base.vb_vf_reg_cass_zip
            = hh_aug.addr_id
    left join election_2024.exp2024_ucg_july as hh_july
        on
            base.vb_tsmart_last_name
            || base.vb_vf_reg_cass_address_full
            || base.vb_vf_reg_cass_city
    ...
    left join
        ...
        on
            ...
            = hh_april.addr_id
    where coalesce(
        aug.vb_voterbase_id, july.vb_voterbase_id, may.vb_voterbase_id, april.vb_voterbase_id,
        hh_july.vb_voterbase_id, hh_may.addr_id, hh_april.addr_id
    ) is null
);
...
drop table if exists election_2024.exp2024_sept_vf_individual_assignment;
create table election_2024.exp2024_sept_vf_individual_assignment as (
    select
        vb_voterbase_id,
        strata,
        strata_size,
...
grant select on election_2024.exp2024_sept_vf_individual_assignment to redash_default;
...
drop table if exists election_2024.exp2024_sept_update_householder_assignment;
create table election_2024.exp2024_sept_update_householder_assignment as (
    select
        addr_id,
        hh_size,
        strata_size,
...
grant select on election_2024.exp2024_sept_update_householder_assignment to redash_default;
