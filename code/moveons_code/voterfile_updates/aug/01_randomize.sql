create temp table base as (
    ...
    from election_2024.exp2024_deduped_20240816 as base
    ...
    left join
        ...
        on
            ...
            = hh_april.addr_id
    where coalesce(
        july.vb_voterbase_id, may.vb_voterbase_id, april.vb_voterbase_id,
...
drop table if exists election_2024.exp2024_aug_vf_individual_assignment;
create table election_2024.exp2024_aug_vf_individual_assignment as (
    select
        vb_voterbase_id,
        strata,
        strata_size,
...
grant select on election_2024.exp2024_aug_vf_individual_assignment to redash_default;
...
drop table if exists election_2024.exp2024_aug_update_householder_assignment;
create table election_2024.exp2024_aug_update_householder_assignment as (
    select
        addr_id,
        hh_size,
        strata_size,
...
grant select on election_2024.exp2024_aug_update_householder_assignment to redash_default;
