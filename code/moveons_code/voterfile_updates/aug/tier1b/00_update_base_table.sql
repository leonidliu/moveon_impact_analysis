...
drop table if exists election_2024.exp2024_basefile_20240816;
create table election_2024.exp2024_basefile_20240816 as (
    select *
    from base
    where
...
(
    ...
    from election_2024.exp2024_basefile_20240816
    where
        is_callable = 1  -- has high quality phone number in the voter file
        and do_not_call = 0 -- not on the do not call list
);

drop table if exists election_2024.exp2024_deduped_20240816;
create table election_2024.exp2024_deduped_20240816 as (
    select base.*
    from election_2024.exp2024_basefile_20240816 as base
...
select
    ...
    count(*)
from election_2024.exp2024_ucg_july as april
full join
    election_2024.exp2024_deduped_20240816 as may
    on april.vb_voterbase_id = may.vb_voterbase_id
group by 1, 2;
