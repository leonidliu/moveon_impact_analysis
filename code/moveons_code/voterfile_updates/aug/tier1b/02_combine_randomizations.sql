...
-- final assignment
drop table if exists election_2024.exp2024_ucg_aug;
create table election_2024.exp2024_ucg_aug as (
    select
        coalesce(
            ind_april.treat,
            hh_april.treat,
    ...
    left join
        election_2024.exp2024_aug_vf_individual_assignment as ind
...
grant select on election_2024.exp2024_ucg_aug to redash_default;
