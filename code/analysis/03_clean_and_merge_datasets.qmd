...
full_clean_df <- df %>%
  ...
  mutate(voted_24 = !is.na(vb_vf_g2024),
         voted_22 = !is.na(vb_vf_g2022),
  ...
  mutate(gender = case_when(vb_voterbase_gender == "Male" ~ "Men", TRUE ~ "Women"),
         race = case_when(civis_race == "WHITE" ~ "White",
                          ...
                          vb_voterbase_race == "W" ~ "White",
                          vb_voterbase_race == "B" ~ "Black",
                          vb_voterbase_race == "H" ~ "Latino",
  ...
  impute_with_missing_flag(age) %>%
  mutate(ts_tsmart_presidential_general_turnout_score_sq = ts_tsmart_presidential_general_turnout_score^2,
         ts_tsmart_partisan_score_sq = ts_tsmart_partisan_score^2)
