...
```{r print_table}
tibble(
  Analysis = c("OLS", "2SLS (subset)", "2SLS (full)", "Meta-Analysis"),
  Effect = round(c(ols_effect_size, twosls_effect_size, full_twosls_effect_size, NA), 3),
  `Low Effect` = round(c(ols_effect_size_low, twosls_effect_size_low, full_twosls_effect_size_low, NA), 3),
  `High Effect` = round(c(ols_effect_size_high, twosls_effect_size_high, full_twosls_effect_size_high, NA), 3),
  `Net Dem Votes` = round(c(ols_net_dem_votes, twosls_net_dem_votes, full_twosls_net_dem_votes, ai_net_dem_votes)),
  `Low Net Dem Votes` = round(c(ols_low_net_dem_votes, twosls_low_net_dem_votes, full_twosls_low_net_dem_votes, ai_low_net_dem_votes)),
  `High Net Dem Votes` = round(c(ols_high_net_dem_votes, twosls_high_net_dem_votes, full_twosls_high_net_dem_votes, ai_high_net_dem_votes))) %>%
  kable(format.args = list(big.mark = ","))
```
